# Accent Services — Production Website
...
- `src/components/home/*` — homepage sections (Hero, "what are you trying to achieve" selector, outcomes, why-Accent, ecosystem, case study, CTA).
