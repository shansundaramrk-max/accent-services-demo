...
export const trustStats = [
  { value: '120+', label: 'Australian businesses supported' },
...
export const testimonials = [
  ...
  {
    quote: 'The Zoho implementation finally gave our sales and operations teams one shared view. Adoption was immediate because they trained the team properly instead of just flipping the switch.',
    name: 'Priya Nair',
...
export const industries = [
  {
    ...
    blurb: 'Enterprise-grade IT and security without an enterprise budget or an internal IT department.',
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&q=80',
  },
  {
    slug: 'enterprise',
    name: 'Enterprise',
    blurb: 'Complex, multi-site environments managed with the governance and reporting an enterprise board expects.',
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80',
  },
  {
    slug: 'retail',
    name: 'Retail',
    blurb: 'Point-of-sale uptime, multi-store networking and seasonal scaling handled without disrupting trade.',
    image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80',
  },
  {
    slug: 'manufacturing',
    name: 'Manufacturing',
    blurb: 'OT/IT convergence, asset visibility and resilient connectivity across plant floors and warehouses.',
    image: 'https://images.unsplash.com/photo-1565043666747-69f6646db940?w=1200&q=80',
  },
  {
    slug: 'professional-services',
    name: 'Professional Services',
    blurb: 'Secure, compliant systems for firms where client confidentiality and uptime are non-negotiable.',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&q=80',
  },
  {
    slug: 'education',
    name: 'Education',
    blurb: 'Reliable connectivity and device management across campuses, with safeguarding-aware security controls.',
    image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1200&q=80',
  },
  {
    slug: 'healthcare',
    name: 'Healthcare',
    blurb: 'Privacy-first systems built around patient data obligations and always-on availability requirements.',
...
export const nav: NavGroup[] = [
  {
    ...
    children: [
      ...
      { label: 'Endpoint Management', to: '/solutions/endpoint-management' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Intelligent Document Processing', to: '/solutions/intelligent-document-processing' },
  ...
  },
  {
    ...
    children: [
      { label: 'Software Testing', to: '/solutions/software-testing' },
      { label: 'Test Automation', to: '/solutions/test-automation' },
      { label: 'API Testing', to: '/solutions/api-testing' },
      { label: 'Performance Testing', to: '/solutions/performance-testing' },
      { label: 'Managed QA', to: '/solutions/managed-qa' },
    ],
  },
]
